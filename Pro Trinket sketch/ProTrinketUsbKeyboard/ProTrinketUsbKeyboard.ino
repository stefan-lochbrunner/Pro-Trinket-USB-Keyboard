...
- See UsbKeyboard.h for some "keyvboard usage values" or usb codes as I called then here
...
int colPins[] = { 4, 14, 15, 16};  //select pins, driven LOW to select col => btn active LOW
int rowPins[] = {19, 17, 18};      //signal pins, read LOW means btn pressed
int encPins[] = {12, 13};          //encoder signal pins
